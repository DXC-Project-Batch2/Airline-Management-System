...
class AirlineMangementsystemApplicationTests {
	...
	public void AdminfindAllTest(){
		when(AdminRepository.findAll()).thenReturn(Stream.of(new Admin("pasupath@dxc.com", "pasupat"), new Admin("p@dxc.com", "pasupathi"))
				.collect(Collectors.toList()));
	...
	public void AdminSecurityfindAllTest(){
		when(adminSecurityServiceImplementation.findAll()).thenReturn(
				Stream.of(new AdminSecurity("pasupathi@dxc.com", "what is favorite number?","100"), new AdminSecurity("p@dxc.com",  "what is favorite number?","100"))
						.collect(Collectors.toList()));
	...
	public void AdminSecurityfindByUsernameTest(){
		...
		when(adminSecurityRepository.findByUsername(username))
				.thenReturn(Stream.of(new AdminSecurity("pasupathi@dxc.com", "what is favorite number?","100")).collect(Collectors.toList()));
