...
public class AirLineServiceTest {
	...
	//findbysno
	@Test
	public void findBySnoTest() throws ParseException{
		
		AirLine airLine = new AirLine(0,110, "airindia","chennai", "goa", "18-07-1999", "150 mins", "2:00 AM", "4:30 AM", 10000, 44,0);
		Mockito.when(airLineRepository.findById(airLine.getSno())).thenReturn(Optional.of(airLine));
	    assertThat(airlineServiceImplementation.findBySno(airLine.getSno())).isEqualTo(airLine);
	...
	//findbyid
		...
		public void findByIdTest() throws ParseException{
			...
			AirLine airLine = new AirLine(0,110, "airindia","chennai", "goa", "18-07-1999", "150 mins", "2:00 AM", "4:30 AM", 10000, 44,0);
			AirLine airLine1 = new AirLine(0,110, "airindia","chennai", "goa", "18-07-2021", "150 mins", "2:00 AM", "4:30 AM", 3000, 44,0);
			AirLine airLine2 = new AirLine(0,111, "airindia","chennai", "goa", "18-07-2021", "150 mins", "2:00 AM", "4:30 AM", 2000, 44,0);
			List<AirLine> airLines = new ArrayList<>();
			airLines.add(airLine);
			airLines.add(airLine1);
			airLines.add(airLine2);
		
			Mockito.when(airLineRepository.findAllById(airLine.getPlaneId())).thenReturn(airLines);
			
			assertThat(airlineServiceImplementation.findById(airLine.getPlaneId())).isEqualTo(airLines);
	...
	//deletebyplaneid
	@Test
	public void deletePlane_IdTest() throws ParseException{
	...
	public void deleteTest() throws ParseException{
	    ...
	    Mockito.when(airLineRepository.findById(airLine.getSno())).thenReturn(Optional.of(airLine));
	    Mockito.when(airLineRepository.existsById(airLine.getSno())).thenReturn(false);
	...
	//NotfindByCities
		...
		public void NotfindByUserTest() throws ParseException{
			...
			AirLine airLine1 = new AirLine(0,110, "airindia","chennai", "goa", "18-07-2021", "150 mins", "2:00 AM", "4:30 AM", 3000, 44,0);
			AirLine airLine2 = new AirLine(1,111, "airindia","chennai", "goa", "18-07-2021", "150 mins", "2:00 AM", "4:30 AM", 2000, 44,0);
			List<AirLine> airLines = new ArrayList<>();
			airLines.add(airLine1);
			airLines.add(airLine2);
